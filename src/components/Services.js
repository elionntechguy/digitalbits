            ...
            <React.Fragment>
                ...
                <CardDeck className="servicescardsdeck" data-aos="fade-up" data-aos-delay="100" data-aos-duration="500" data-aos-offset="500">
                    ...
                    <Card style={{ width: '12rem' }}>
                        <i style={{fontSize: '10vw', alignSelf: 'center', marginTop: '20px'}} className="fas fa-code"></i>
                        <Card.Body>
                    ...
                    <Card style={{ width: '12rem' }}>
                        <i style={{fontSize: '10vw', alignSelf: 'center', marginTop: '20px'}} className="fas fa-hashtag"></i>
                        <Card.Body>
                    ...
                    <Card style={{ width: '12rem' }}>
                        <i style={{fontSize: '10vw', alignSelf: 'center', marginTop: '20px'}} className="fas fa-paint-brush"></i>
                        <Card.Body>
